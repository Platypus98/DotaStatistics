...
{
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Internet connection" message:@"Для получения данных необходимо интернет соединение. Проверьте его и повторите попытку." preferredStyle:UIAlertControllerStyleAlert];
